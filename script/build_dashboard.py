...
// Basemap Esri Canvas: CARTO da settembre 2026 serve tile con filigrana
// "API KEY REQUIRED". Esri non richiede chiave, ma i suoi tile si fermano a
// z=16 (oltre restituisce un segnaposto di 2.521 byte), quindi maxNativeZoom.
