/* @ds-bundle: {"format":3,"namespace":"IZILabDesignSystem_03588f","components":[{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"IconButton","sourcePath":"components/core/IconButton.jsx"},{"name":"Tag","sourcePath":"components/core/Tag.jsx"},{"name":"ProgressBar","sourcePath":"components/feedback/ProgressBar.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Select","sourcePath":"components/forms/Select.jsx"},{"name":"Switch","sourcePath":"components/forms/Switch.jsx"},{"name":"Card","sourcePath":"components/surfaces/Card.jsx"},{"name":"Kicker","sourcePath":"components/surfaces/Kicker.jsx"},{"name":"StatCard","sourcePath":"components/surfaces/StatCard.jsx"}],"sourceHashes":{"components/core/Badge.jsx":"4c0057c39648","components/core/Button.jsx":"b519c508696d","components/core/IconButton.jsx":"d542f506a6fc","components/core/Tag.jsx":"24fafdaecb8f","components/feedback/ProgressBar.jsx":"f71b332d9cc2","components/forms/Input.jsx":"40e31ac2e65e","components/forms/Select.jsx":"40f869d46885","components/forms/Switch.jsx":"99846d360b19","components/surfaces/Card.jsx":"e5cf11cee4fe","components/surfaces/Kicker.jsx":"e20e1acec2f7","components/surfaces/StatCard.jsx":"93ca9f006491","decks/chorema-investor/deck-stage.js":"208980974db4","ui_kits/foreseen-carousel/App.jsx":"518634545570","ui_kits/foreseen-carousel/CarouselSlide.jsx":"011c648efe00","ui_kits/foreseen-carousel/data.js":"b50a2ae98eb3"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.IZILabDesignSystem_03588f = window.IZILabDesignSystem_03588f || {});
...
function Badge({
  ...
  const palette = {
    ...
    primary: {
      ...
      soft: "rgba(142,125,246,0.20)",
      softFg: "var(--violet-300)",
      line: "var(--violet-400)"
    },
    neutral: {
      solid: "var(--blanche-700)",
      fg: "var(--blanche-100)",
      soft: "rgba(150,149,167,0.18)",
      softFg: "var(--text-muted)",
...
function Button({
  ...
  const base = {
    ...
    transition: "background var(--dur-fast) var(--ease-standard), transform var(--dur-fast) var(--ease-standard), box-shadow var(--dur-base) var(--ease-standard), border-color var(--dur-fast) var(--ease-standard)",
    ...v,
    ...style
  };
  const hoverBg = {
...
function IconButton({
  ...
  return /*#__PURE__*/React.createElement("button", _extends({
    ...
    onMouseEnter: e => {
      if (!disabled && variant === "ghost") e.currentTarget.style.background = "var(--surface-raised)";
      if (!disabled && variant === "outline") e.currentTarget.style.borderColor = "var(--color-accent)";
    },
    onMouseLeave: e => {
      if (!disabled) {
        e.currentTarget.style.background = v.background;
...
function Input({
  ...
  const borderColor = error ? "var(--color-danger)" : focus ? "var(--focus-ring)" : "var(--border-default)";
...
// components/surfaces/Kicker.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/**
...
function Kicker({
  ...
  }, number, ". "), children), rule && /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      display: "block",
      width: 40,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/surfaces/Kicker.jsx", error: String((e && e.message) || e) }); }
...
// decks/chorema-investor/deck-stage.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "decks/chorema-investor/deck-stage.js", error: String((e && e.message) || e) }); }

// ui_kits/foreseen-carousel/App.jsx
try { (() => {
...
function ScaledSlide({
  ...
  }, /*#__PURE__*/React.createElement(window.CarouselSlide, {
    data: data
  })));
}
function Thumb({
...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    src: "../../assets/logo/logo-izilab.png",
    alt: "IZILab",
    style: {
      height: 20
    }
  ...
  }, "Foreseen"), /*#__PURE__*/React.createElement(Badge, {
    tone: "accent",
    variant: "soft"
  }, "Carousel")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      alignItems: "center"
  ...
  }, "Pubblica"))), /*#__PURE__*/React.createElement("main", {
    style: {
      flex: 1,
      display: "flex",
      alignItems: "center",
  ...
  }, /*#__PURE__*/React.createElement(ScaledSlide, {
    data: SLIDES[i]
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    style: {
      ...
      borderRadius: 999,
      cursor: "pointer",
      background: k === i ? "var(--color-accent)" : "var(--surface-raised)",
      border: "1px solid var(--border-default)",
  ...
  }, SLIDES.map((s, k) => /*#__PURE__*/React.createElement(Thumb, {
    key: k,
    data: s,
    index: k,
    active: k === i,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/foreseen-carousel/App.jsx", error: String((e && e.message) || e) }); }

// ui_kits/foreseen-carousel/CarouselSlide.jsx
try { (() => {
...
function CarouselSlide({
  ...
  const c = dark ? {
    kicker: "var(--violet-300)",
    title: "var(--aqua-200)",
    body: "var(--blanche-400)",
    base: "#0F0830"
  } : {
    kicker: "#575767",
    title: "#541BC6",
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, data.bg && dark && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      background: "linear-gradient(180deg, rgba(15,8,48,0.35) 0%, rgba(15,8,48,0.78) 100%)"
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      ...
      display: "flex",
      alignItems: "center",
      background: dark ? "#FDFDFF" : "transparent",
      padding: dark ? "8px 12px" : 0,
  ...
  })), data.type === "cover" ? /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      inset: 0,
      zIndex: 2,
  ...
  }, data.kicker), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "var(--font-display)",
      fontWeight: 500,
      fontSize: 56,
    ...
    style: {
      flex: 1,
      height: 2,
      background: dark ? "rgba(236,236,255,0.18)" : "rgba(39,39,53,0.14)"
    }
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 34,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/foreseen-carousel/CarouselSlide.jsx", error: String((e && e.message) || e) }); }

// ui_kits/foreseen-carousel/data.js
try { (() => {
/* Foreseen carousel — slide data (real copy from the IZILab social system).
   Attaches to window for the babel-transpiled app scripts. */
window.IZI_FORESEEN = {
  slides: [{
    type: "cover",
    theme: "dark",
    bg: "../../assets/backgrounds/bg-dark-bloom.png",
    title: "The Foreseen",
    subtitle: "Tutto ciò che ti serve\nper guardare al futuro"
  }, {
    type: "content",
    theme: "dark",
    bg: "../../assets/backgrounds/bg-dark-aurora.png",
    kicker: "1. Cosa troverai",
    title: "Racconto futuristico tratto dalla serie Newrbania",
    body: "Una raccolta di storie ambientate in dodici metropoli europee proiettate in un futuro possibile."
  }, {
    type: "content",
    theme: "light",
    kicker: "3. Cosa troverai",
    title: "Innovazioni del mese",
    body: "Una sezione dedicata alle ultime tecnologie e alle nuove applicazioni più rilevanti nel mondo dell'intelligenza artificiale, delle smart cities, della data science, dei big data e di GenAI."
  }, {
    type: "content",
    theme: "light",
    kicker: "5. Cosa troverai",
    title: "Community",
    body: "Ogni contributo sarà parte integrante del nostro percorso. Ti segnaleremo gli eventi più significativi del mese e ti porremo una domanda per stimolare le tue riflessioni."
  }, {
    type: "content",
    theme: "dark",
    bg: "../../assets/backgrounds/bg-dark-wisp.png",
    kicker: "6. Cosa troverai",
    title: "Risorse per approfondire",
    body: "Una sezione in cui troverai articoli, libri, podcast e link utili per continuare a esplorare il futuro."
  }]
};
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/foreseen-carousel/data.js", error: String((e && e.message) || e) }); }
